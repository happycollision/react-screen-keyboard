...
var KeyboardButton = function (_PureComponent) {
	...
	function KeyboardButton() {
		...
		return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = KeyboardButton.__proto__ || Object.getPrototypeOf(KeyboardButton)).call.apply(_ref, [this].concat(args))), _this), _this.allowOnly = 0, _this.handleValidInput = function () {
	...
	_createClass(KeyboardButton, [{
		key: 'handleClickAttempt',
		value: function handleClickAttempt(e) {
		...
		key: 'handleTouchAttempt',
		value: function handleTouchAttempt(e) {
