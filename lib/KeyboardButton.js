...
var KeyboardButton = function (_PureComponent) {
	...
	function KeyboardButton() {
		...
		return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = KeyboardButton.__proto__ || Object.getPrototypeOf(KeyboardButton)).call.apply(_ref, [this].concat(args))), _this), _this.handleValidInput = function () {
			if (!_this.props.isDisabled) {
				_this.props.onClick(_this.props.value);
			}
		}, _this.handleClickAttempt = function (e) {
			if (allowOnly === 2) return;
			if (allowOnly === 0) allowOnly = 1;
			if (allowOnly === 1) _this.handleValidInput();
		}, _this.handleTouchAttempt = function (e) {
			if (allowOnly === 1) return;
			if (allowOnly === 0) allowOnly = 2;
			if (allowOnly === 2) _this.handleValidInput();
